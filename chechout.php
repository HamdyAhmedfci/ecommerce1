...
<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post"> 
    ...
    <input type="hidden" name="business" value="business1233@gmail.com"> 
    ...
    <input type="hidden" name='return_cancel' value='http://moobd3.org/ecommerce/paypal_cancel.php'>

    <!-- Display the payment button. --> 
    <input type="image" name="submit" border="0" src="images/paypal.png" alt="Buy Now"> 
